...
// 获取函数的参数
type MyParameters<T extends (...args: any[]) => any> = T extends (...args: infer Res) => any ? Res : never

type test_parameters = MyParameters<typeof foo>
type test_parameters2 = MyParameters<typeof bar>
type test_parameters3 = MyParameters<typeof baz>
